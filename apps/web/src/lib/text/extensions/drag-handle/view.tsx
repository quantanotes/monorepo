...
import { dragHandlePluginDefaultKey, DragHandlePlugin } from './plugin';
import type { DragHandlePluginProps } from './plugin';
...
export const DragHandleView = (props: DragHandleProps) => {
  const {
